...
function TodoForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-green-600 hover:bg-green-700 cursor-pointer active:scale-95 text-white font-semibold px-6 py-2.5 transition-all duration-200 flex items-center justify-center gap-2 shrink-0"
      >
        <span>Add</span>
        <svg
